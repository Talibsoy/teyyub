  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ background: "white", border: "1px solid #e2e8f0", borderRadius: 12, padding: "16px 20px", marginBottom: 28 }}>
          <div style={{ color: "#25D366", fontSize: 13, fontWeight: 600, marginBottom: 4 }}>Növbəti addım</div>
          <div style={{ color: "#64748b", fontSize: 13 }}>Pasport + uçuş təfərrüatları üçün WhatsApp-da bizimlə əlaqə saxlayın</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <Link href="/" style={{ color: "#94a3b8", fontSize: 13, textDecoration: "none" }}>Ana Səhifəyə Qayıt</Link>
        </div>
      </div>
    </div>
  );

    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ color: "#25D366", fontSize: 13, fontWeight: 600, marginBottom: 4 }}>
            Növbəti addım
          </div>
          <div style={{ color: "#aaa", fontSize: 13 }}>
            Pasport + uçuş təfərrüatları üçün WhatsApp-da bizimlə əlaqə saxlayın
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <a
            href={waLink("Salam, ödənişim keçdi, rezervasiya təsdiqi üçün yazıram")}
            target="_blank"

          ...
          {wishlist.map((item) => (
            <div key={item.id} style={{
              ...
              <div style={{ padding: "14px 16px" }}>
                ...
                <Link
                  href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "447828721748"}?text=Salam%2C%20${encodeURIComponent(item.tour_name)}%20tur%20haqq%C4%B1nda%20m%C9%99lumat%20almaq%20istirdim`}
                  target="_blank"

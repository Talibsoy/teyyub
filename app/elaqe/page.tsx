  ...
  return (
    <div style={{ background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 md:py-14 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-5">
            {[
              ...
              <div key={item.title} className="flex gap-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center text-base flex-shrink-0" style={{ background: "white", border: "1px solid #e2e8f0" }}>
                  {item.icon}
                </div>
                <div>
        ...
        {/* Form */}
        <div className="rounded-2xl p-5 md:p-6" style={{ background: "white", border: "1px solid #e2e8f0" }}>
          {sent ? (

...
export const DICTIONARIES: Record<Locale, TranslationDictionary> = {
  ...
  en: {
    ...
    heroBadge: "AI Travel Decision Engine",
    heroGreeting: "📍 Welcoming you from {city}, {country}! Nearest airport: {airport}",
    heroTitleStart: "Your Travel",
    heroTitleMiddle: "Reduced to 3",
    heroTitleEnd: "Perfect Results.",
    heroSubtitle: "NatoureFly analyzes your Travel DNA, filters through thousands of options, and presents only 100% matched, fully budgeted holistic itineraries.",
    startDna: "Start Travel DNA",
    startGuide: "Start with AI Guide",
    statsMatch: "Matching Accuracy",
    statsDest: "Destinations",
    ...
    searching: "Searching...",
    orPrompt: "Or Search with Natural Language Prompt",
    placeholderPrompt: "e.g. Next month I want to go somewhere romantic with my spouse, our budget is 2000 USD...",
    aiAskButton: "AI Ask",

    dnaTitle: "Your Travel DNA Analyzed",
    dnaSubtitle: "Tours are ranked based on your psychometric profile. The most matched options appear at the top.",
    viewTours: "View My Tours",
    viewAllTours: "View All Tours",

    packageTitle: "Natoure Package",
    perPerson: "Per person",
    totalPrice: "Total",
    flightIncluded: "Round-trip flight included",
    conciergeFeeIncluded: "flynatoure concierge fee & taxes included",
    direct: "Direct",
    stops: "stop",
